    ...
    <div className="min-h-screen bg-[#050505] text-white p-4 md:p-8 font-sans">
      <div className="max-w-5xl mx-auto pb-8">
        <div className="mb-8">
          ...
          <p className="text-neutral-500 text-xs uppercase tracking-widest mt-2">Rules, commands, procedures, and team docs</p>
        </div>
        ...
        {filtered.length === 0 && (
          <div className="text-xs text-neutral-600 uppercase tracking-widest mt-12">No published articles yet.</div>
        )}
      </div>
    </div>
  );
